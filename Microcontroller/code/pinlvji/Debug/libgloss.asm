...
// Command: C:\PROGRA~1\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\cc0Bl7de.i -fkeep-inline-functions -quiet -dumpbase libgloss.c -mglobal-var-iram -gstabs -Wall -o .\Debug/libgloss.asm
...
.code
.debug
	.dw '.stabs "D:/Ð/302½/250Î/304¼/376¼/320/123/libgloss.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
